   ...
   <div class="container current-page">
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            <a href="index" class="breadcrumb">jShop</a>
  ...
  <div class="row">
             ...
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a href="infoproduct" class="blue-text">View Settings</a>
               </div>
             </div>
           </div>
         </div>
        ...
        <div class="card-content">
          <p>Stock</p>
             ...
             <div class="card-action">
               <a href="products" class="blue-text">View Stocks</a>
             </div>
             </div>
           ...
           <div class="card horizontal">
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a href="allusers" class="blue-text">View Users</a>
               </div>
             </div>
           </div>
         </div>
