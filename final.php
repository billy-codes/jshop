...
// page to be displayed when purchased is made
 ...
 if (isset($_POST['pay'])) {
    ...
    $query_details = "INSERT INTO details_command(product,quantity,price,id_command,id_user,user,address,country,city,statut) 
                        VALUES('$productcmd','$quantitycmd','$price','$idcmd','$idusercmd','$fullname','$addresscmd','$countrycmd','$citycmd','ready')";
